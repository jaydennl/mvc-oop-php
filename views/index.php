            ...
            <div class="carousel">
                ...
                <div class="items" id="clubs">
                    <?php foreach ($clubs as $club): ?>
                        <div class="item">
                            <img src="<?= htmlspecialchars($club['image']) ?>" alt="<?= htmlspecialchars($club['name']) ?>" class="club-photo">
                            <p><?= htmlspecialchars($club['name']) ?></p>
                        </div>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="carousel">
                ...
                <div class="items" id="spelers">
                    <?php foreach ($players as $player): ?>
                        <div class="item">
                            <img src="<?= htmlspecialchars($player['image']) ?>" alt="<?= htmlspecialchars($player['name']) ?>" class="player-photo">
